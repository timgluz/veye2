...
var veye2 = {core:{}};
veye2.core.path = cljs.nodejs.require.call(null, "path");
veye2.core.Electron = cljs.nodejs.require.call(null, "electron");
veye2.core.BrowserWindow = cljs.nodejs.require.call(null, "browser-window");
veye2.core.crash_reporter = cljs.nodejs.require.call(null, "crash-reporter");
veye2.core._STAR_win_STAR_ = cljs.core.atom.call(null, null);
veye2.core.app = veye2.core.Electron.app;
veye2.core._main = function() {
  veye2.core.crash_reporter.start(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "companyName", "companyName", 2030952346), "VersionEye", new cljs.core.Keyword(null, "submitURL", "submitURL", -169159433), "http://github.com/timgluz/veye2"], null)));
  cljs.nodejs.process.on("error", function(a) {
    return console.log(a);
  });
  veye2.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? veye2.core.app.quit() : null;
  });
  return veye2.core.app.on("ready", function() {
    cljs.core.reset_BANG_.call(null, veye2.core._STAR_win_STAR_, new veye2.core.BrowserWindow(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "width", "width", -384071477), 800, new cljs.core.Keyword(null, "height", "height", 1025178622), 600], null))));
    cljs.core.deref.call(null, veye2.core._STAR_win_STAR_).loadURL([cljs.core.str("file://"), cljs.core.str(veye2.core.path.resolve(__dirname, "../index.html"))].join(""));
    return cljs.core.deref.call(null, veye2.core._STAR_win_STAR_).on("closed", function() {
      return cljs.core.reset_BANG_.call(null, veye2.core._STAR_win_STAR_, null);
    });
  });
};
cljs.nodejs.enable_util_print_BANG_.call(null);
cljs.core._STAR_main_cli_fn_STAR_ = veye2.core._main;
cljs.nodejscli = {};
